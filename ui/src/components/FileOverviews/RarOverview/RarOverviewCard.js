...
const RarOverviewCard = ({ data }) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a, b) => parseInt(a.file_size) - parseInt(b.file_size),
      width: 100,
    },
    {
      ...
      render: (rate) => (
        <Text style={{ float: "right", fontSize: "12px" }}>{rate.toFixed(2)}%</Text>
      ),
        ...
        <Col span={16}>
          ...
          >
            ...
            <Descriptions.Item
              ...
              labelStyle={{ width: "140px", fontSize: "12px" }}
            >
              <Text style={{ fontSize: "12px" }}>{data.scan.rar.compression_rate}%</Text>
            </Descriptions.Item>
            <Descriptions.Item
              label="Host OS"
              labelStyle={{ width: "140px", fontSize: "12px" }}
            ...
            {data.scan.rar.flags && (
              <Descriptions.Item
                ...
                labelStyle={{ width: "140px", fontSize: "12px" }}
              >
                {data.scan.rar.flags.map((flag, index) => (
                  <Tag
                    key={index}
                    color="orange"
