const results = [
  {
    ...
    _source: {
      ...
      request: {
        source:
          '4703687471562752-1b8d03c651f637fc49cdf29dbd22ca08-237902023094665c3b3e95896af8dd6ebbcfe4dc1b3841c6894e5809c6721411-1619986164',
        time: 1620078276,
        client: 'elastalert',
        ...
        attributes: {
          ...
          metadata: {
            ...
            archive_file:
              'elastalert/vtn/identification_rules_ke/docx_template_injection/application/zip/524a4cde5b5df4b2fc19ce9052d6e8c7',
            full_url:
              'https://www.virustotal.com/vtapi/v2/file/feed/download?token=',
            rule_author: 'Mike Pananen',
            rule_description:
              'Rule that fires on all vt_notifications with ephemeral_download_link',
          },
        },
      },
      ...
      scan_hash: {
        ...
        sha256:
          '575825c8a72e414329f1cecc37a59c723ffba5ba6940abe4d3c928ce0c664d5f',
        elapsed: 0.000161,
    ...
    fields: {
      '@timestamp': ['2021-05-03T21:48:21.103Z'],
      'request.time': ['2021-05-03T21:44:36.000Z'],
    },
    sort: [1620078501103],
  },
  {
    ...
    _source: {
      ...
      scan_hash: {
        ...
        sha256:
          '99108fbd0233baac062fb41ecea972ed1c4e183b732014107c4803bfc5d73295',
        elapsed: 0.000227,
        sha1: '6bb1adc6c26947cb7140f57b385ae6a7f0ab37b6',
        ssdeep:
          '3:yionv//thPlhdl9DAyltYtJVAlnfF//ll3lurpmX/cqlCQhl/O7OgGFBuHB6VkVp:6v/lhPVfqtJilusDlh47ODTuh6mp',
      },
      host: {
        name: '8ea04ea7b4a9',
      },
